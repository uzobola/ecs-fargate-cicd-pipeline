...
| [Phase 3A](phase-03-bootstrap-env-infrastructure.md) | Establish Terraform authentication, secure remote state, state migration, and S3-native locking |
| [Phase 3B-3E](phase-03-aws-infrastructure.md) | Provision ECR, networking, security boundaries, ALB, ECS Fargate, and Application Auto Scaling |
